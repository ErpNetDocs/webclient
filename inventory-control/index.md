...
You can **receive**, **issue**, **reconcile**, **transfer** and **scrap** orders in just a few steps, thereby generating receipt stores, issue store orders and reconciliation documents in no time. Тhese actions are **not** synchronized in real-time with the ERP.net system.
