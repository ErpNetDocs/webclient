...
![My apps - Tiles](./pictures/my-apps-no-context.png)

And see now what it visualizes if placed in Crm -> Common:

![Widget tile - Customers context](./pictures/my-apps-context-1.png)

Or even more specifically - Crm -> Common -> Price Lists:

![Widget tile - Stores navigator context](./pictures/my-apps-context-2.png)
...
![Widget tile - Stores navigator context](./pictures/my-apps-sett-1.png)

3. Expand the "Widget Panels" category and just check the ones you want to include.
![Widget tile - Stores navigator context](./pictures/my-apps-sett-2.png)
