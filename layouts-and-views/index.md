...
A significant role in the customization plays the [App-bar menu](https://docs.erp.net/webclient/layouts-and-views/guide/appbar-menu-options.html). It allows you to control how the Web Client interface behaves and what UI elements are visible on the screen.
